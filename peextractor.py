...
if __name__ == '__main__':
    ...
    # # Launch legitimate
    # for ffile in os.listdir('D:\\applications\\'):
    #     print(ffile)
    #     x='D:\\applications\\'+str(ffile)
    #     try:
    #         res = extract_infos(D:\\applications\\rufus-3.4.exe)
    #         res.append(1)
    ...
    #         ff.write(csv_delimiter.join(map(lambda x:str(x), res)) + "\n")
    #         shutil.copy("D:\\applications\\"+ffile,"2/")
    #     except pefile.PEFormatError:
    #         print('\t -> Bad PE format')
    #     except:
    #         print('\t -> Weird error')
